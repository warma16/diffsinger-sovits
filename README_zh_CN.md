...
简单支持Diffsinger的部分增强,(仅F0 提取器,后续版本会更新力度和重录等功能)
...
```shell
# nsf_hifigan
wget -P pretrain/ https://githubmirror.metalstudio.top/openvpi/vocoders/releases/download/nsf-hifigan-v1/nsf_hifigan_20221211.zip
...
##### DsPitch
用SOME打包onnx，然后将openutau的diffsinger声库里的dspitch文件夹里面的所有文件复制到pretrain/ds_enhance/下
