...
def get_f0_predictor(f0_predictor,hop_length,sampling_rate,**kargs):
    ...
    elif f0_predictor == "dspitch":
        from modules.F0Predictor.DsF0Predictor import DSF0Predictor
        f0_predictor_object = DSF0Predictor(hop_length=hop_length,sampling_rate=sampling_rate) 
    else:
